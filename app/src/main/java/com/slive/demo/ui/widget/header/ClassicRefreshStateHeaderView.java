package com.slive.demo.ui.widget.header;
 ...
 */
public class ClassicRefreshStateHeaderView extends RelativeLayout implements RefreshStateListener {
    ...
    public ClassicRefreshStateHeaderView(Context context) {
        this(context, null);
    }

    public ClassicRefreshStateHeaderView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClassicRefreshStateHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
