...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_pagerTabBackground, tabBackgroundResId);
        ...
        textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_pagerTextAllCaps, textAllCaps);
